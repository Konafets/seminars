...
class Tx_Seminars_Registration extends Tx_Seminars_OldModel_Abstract {
	 ...
	 * @param \TYPO3\CMS\Frontend\Plugin\AbstractPlugin $plugin an object for a live page
	 *
	 * @return string the values retrieved from $this->userData, may be empty
	 */
	public function getUserDataAsHtml($keys, \TYPO3\CMS\Frontend\Plugin\AbstractPlugin $plugin) {
